...
export function useCrowdData() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await fetch(`https://e4ax1x5afb.execute-api.ap-south-1.amazonaws.com/prod/api/stats`);
      if (response.ok) {
  ...
  const checkHealth = useCallback(async () => {
    try {
      const response = await fetch(`https://e4ax1x5afb.execute-api.ap-south-1.amazonaws.com/prod/api/health`);
      if (response.ok) {
  ...
  const startProcessing = useCallback(async () => {
    try {
      const response = await fetch(`https://e4ax1x5afb.execute-api.ap-south-1.amazonaws.com/prod/api/start`, { method: 'POST' });
      if (response.ok) {
  ...
  const stopProcessing = useCallback(async () => {
    try {
      const response = await fetch(`https://e4ax1x5afb.execute-api.ap-south-1.amazonaws.com/prod/api/threshold`, { method: 'POST' });
  ...
  const uploadMedia = useCallback(async (file: File) => {
    ...
    try {
      const response = await fetch(`https://e4ax1x5afb.execute-api.ap-south-1.amazonaws.com/prod/api/upload`, {
        method: 'POST',
        body: formData,
      });
